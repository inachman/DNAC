...
class Assurance_Troubleshoting:
    def __init__(self):
        ...
        print("1. Elastic Search - Collect Flowmetric By 5 minutes Label- nfAppMetricAggregation_5_min/nfMetricAggregation_5_min")
        print("2. TCPDUMP FNF Traffic - Confirm and Capture Traffic on Port 6007")
        print("3. Confirm That Performance Monitory / Flow Monitor Is Implemented on Device Switch/Router")
        print("4. Collect Elastic Search Information by 1 Hour Label -nfAppMetricAggregation_element_PT1H_PT1H ")
        print("5. Confirm that Clock is Sync on Both Device & DNA Cluster ")
        print("6. Exit from Assurance Script")

        selection = int(input("Enter Choice: "))
        if selection == 1:
            self.collect_flowmetrics_from_elastic()
            anykey = raw_input("Enter anything to return to main menu")
            self.__init__()
        elif selection == 2:
...
### Step 1 Troubleshoting to confirm that Elastic Serach have the information Required ###
    def collect_flowmetrics_from_elastic(self):
        ...
        print(ascii_banner)
        self.ipdna =raw_input("Enter Your DNA Cluster IP Address:")
        self.username = raw_input("Enter Your Username:")
        self.password =  raw_input("Enter your Password:")
        self.port = 2222
        self.application_names = raw_input("Please Insert Specific ApplicationName or Just Press Enter For All Applications:")
        self.exporterIpAddress = raw_input("Insert the Exporter IP Address Device or Just Press Enter For All Exporters:")
        self.range_range_gte = raw_input("Insert Start Range(Convention Need to Be Year-Month-Day & Hours:Minutes:Seconds) or Just Press Enter For Getting Existing Applications in the Last 15 Minutes:")
        self.range_range_lte = raw_input("Insert End Range(Convention Need to Be Year-Month-Day & Hours:Minutes:Seconds)or Just Press Enter For Getting Existing Applications in the Last 15 Minutes:")
        self.numberofresults = raw_input("Insert the Number of Results you are looking for(Example: 5,10 ,20 ,50) or Just Press Enter For Getting 10 Results:")
        self.label = raw_input("Insert label nfAppMetricAggregation_5_min or Just press Enter for nfMetricAggregation_5_min:")
...
### Step 2 Troubleshoting to confirm that FNF Is Recived onthe DNA server port 6007 ###
    ...
    def capture_fnf_traffic_confirm_that_received_traffic_port6007(self):
        ...
        self.username = raw_input("Enter Your Username:")
        self.password =  raw_input("Enter your Password:")
        input_exporter_device = raw_input("Please Enter The Exporter IP Address Device:")
        self.port = 2222
        # Step1: SSH To the DNA Server #
        ssh_client = paramiko.SSHClient()
        # ssh_client
    ...
    def fnf_confirm_on_device(self):
        ...
        try:
            ipaddress_input = raw_input("Enter your IP Device:")
            username_input = raw_input("Enter your Username Device:")
            password_input = raw_input("Enter your Password Device:")
    ...
    def ntp_confirm_on_devices(self):
        ...
        try:
            cisco_3x = {
                ...
                'ip': raw_input("Enter your IP Device ( SSH Protocol): "),
                'username': raw_input("Enter your Username: "),
                'password': raw_input("Enter your Password: "),
                'secret': raw_input("Enter you Enable Password: "),
            }
